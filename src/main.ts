...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let disabledPlugins: { [key: string]: boolean } = {
    ace: false,
    badges: false,
    d3: false,
    hljs: false,
  ...
  Reveal.initialize({
    ...
    dependencies: [
      ...
      { src: "/node_modules/reveal-ace-editor/ace.js", async: true, condition: () => !disabledPlugins.ace },
...
function addDetailsToast(title: string, byline: string, image: string) {
...
function addVenue(venue: string, sponsorLogos: string[] = []) {
...
function getGitHubProfileImage(github: string) {
